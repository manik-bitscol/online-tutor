        ...
        <div class="row">
                    ...
                    <tbody>
                        @forelse($jobCirculars as $jobCircular)
                            <tr>
                                ...
                                <td><a href="{{ asset($jobCircular->job_circular_image) }}" class="btn btn-success btn-sm" download="{{ asset($jobCircular->job_circular_image) }}"><i class="fa-solid fa-download mr-5"></i>Download Now</a></td>
                                <td>@includeIf('components.buttons.delete', ['url' => route('delete.job.document',$jobCircular->id)])</td>
                            </tr>
                        @empty
                            No Data Found
                        @endforelse
            ...
            <div class="col-md-4">
                <div class="card p-3">
                    ...
                    <form action="{{route('store.job.document')}}" class="form" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="file" class="form-control" name="job_circular_image" id="job-circular-image" value="{{old('job_circular_image')}}" accept="image/*" required>

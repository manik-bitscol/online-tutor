        ...
        <div class="row">
                    ...
                    <tbody>
                        @forelse($hardCopis as $hardCopy)
                            <tr>
                                ...
                                <td><a href="{{ asset($hardCopy->hard_copy_image) }}" class="btn btn-success btn-sm"
                                        download="{{ asset($hardCopy->hard_copy_image) }}"><i
                                            class="fa-solid fa-download mr-5"></i>Download Now</a></td>
                                <td>@includeIf('components.buttons.delete', [
                                    'url' => route('delete.hardcopy.document', $hardCopy->id),
                                ])</td>
                            </tr>
                        @empty
                            No Data Found
            ...
            <div class="col-md-4">
                <div class="card p-3">
                    ...
                    <form action="{{ route('store.hardcopy.document') }}" class="form" method="POST"
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="file" class="form-control" name="hard_copy_image" id="hard-copy-image"
                                value="{{ old('hard_copy_image') }}" accept="image/*" required>

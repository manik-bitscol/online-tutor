        ...
        <div class="row">
                    ...
                    <tbody>
                        @forelse($admitCards as $admitCard)
                            <tr>
                                ...
                                <td><a href="{{ asset($admitCard->admit_card_image) }}" class="btn btn-success btn-sm"
                                        download="{{ asset($admitCard->admit_card_image) }}"><i
                                            class="fa-solid fa-download mr-5"></i>Download Now</a></td>
                                <td>@includeIf('components.buttons.delete', [
                                    'url' => route('delete.admit.document', $admitCard->id),
                                ])</td>
                            </tr>
                        @empty
                        @endforelse
            ...
            <div class="col-md-4">
                <div class="card p-3">
                    ...
                    <form action="{{ route('store.admit.document') }}" class="form" method="POST"
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="file" class="form-control" name="admit_card_image" id="admit-card-image"
                                value="{{ old('admit_card_image') }}" accept="image/*" required>
